...
public class InventoryDao extends AbstractDao{
    private final static String SELECT_BY_BARCODE = "select p from InventoryPojo p where barcode=:barcode";
    private final static String SELECT_BY_PRODUCT_ID = "select p from InventoryPojo p where productId=:productId";
